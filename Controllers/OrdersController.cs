...
namespace Udrea_Carina_Lab2.Controllers
{
    public class OrdersController : Controller
    {
        ...
        public OrdersController(Udrea_Carina_Lab2Context context)
        {
            _context = context;
        }
        ...
        {
            var udrea_Carina_Lab2Context = _context.Order.Include(o => o.Book).Include(o => o.Customer);
            return View(await udrea_Carina_Lab2Context.ToListAsync());
        }
